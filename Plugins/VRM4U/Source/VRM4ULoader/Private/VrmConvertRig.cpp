...
namespace {
	...
	static void LocalSolverSetup(UIKRigController* rigcon, UVrmAssetListObject *assetList) {
		...
		sol->SetRootBone(assetList->SkeletalMesh->GetRefSkeleton().GetBoneName(0));
...
bool VRMConverter::ConvertRig(UVrmAssetListObject *vrmAssetList) {
	...
	if (vrmAssetList && VRMConverter::Options::Get().IsGenerateRigIK()) {
		...
		{
			FString name = FString(TEXT("IK_")) + vrmAssetList->BaseFileName;
...

		{
			...
			FString name = FString(TEXT("IK_")) + vrmAssetList->BaseFileName + TEXT("_EpicSkeleton");
...

		{
			...
			FString name = FString(TEXT("IK_")) + vrmAssetList->BaseFileName + TEXT("_EpicSkeleton_IK");
			...
			TArray<TT> table = {
				{TEXT("hips"),				TEXT("upperChest"),},
				{TEXT("hips"),				TEXT("chest"),},
				{TEXT("neck"),				TEXT("head"),},
				{TEXT("rightShoulder"),		TEXT("rightHand"),},
				{TEXT("leftShoulder"),		TEXT("leftHand"),},
				{TEXT("rightUpperLeg"),		TEXT("rightToes"),},
				{TEXT("leftUpperLeg"),		TEXT("leftToes"),},

				{TEXT("leftThumbProximal"),		TEXT("leftThumbDistal"),},
				{TEXT("leftIndexProximal"),		TEXT("leftIndexDistal"),},
				{TEXT("leftMiddleProximal"),	TEXT("leftMiddleDistal"),},
				{TEXT("leftRingProximal"),		TEXT("leftRingDistal"),},
				{TEXT("leftLittleProximal"),	TEXT("leftLittleDistal"),},

				{TEXT("rightThumbProximal"),	TEXT("rightThumbDistal"),},
				{TEXT("rightIndexProximal"),	TEXT("rightIndexDistal"),},
				{TEXT("rightMiddleProximal"),	TEXT("rightMiddleDistal"),},
				{TEXT("rightRingProximal"),		TEXT("rightRingDistal"),},
				{TEXT("rightLittleProximal"),	TEXT("rightLittleDistal"),},
			};
			...
			for (auto& t : table) {
				...
				if (baseBone != "" && conv.s1 != "" && conv.s2 != "") {
					rigcon->AddRetargetChain(*baseBone, *conv.s1, *conv.s2);
				}
			}
